...
export interface ApiAuditLogAuditLog extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Track all document actions';
...
export interface ApiCollaboratorCollaborator
  ...
  info: {
    description: 'Document collaborators with roles';
...
export interface ApiDocumentDocument extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Collaborative documents with versioning';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    originalFile: Schema.Attribute.Media<'files' | 'images'>;
    owner: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    plainContent: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    ...
    status: Schema.Attribute.Enumeration<
      ['draft', 'review', 'signed', 'completed', 'archived']
    > &
...
export interface ApiSignatureSignature extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    signer: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    signerEmail: Schema.Attribute.Email & Schema.Attribute.Required;
    signerName: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
